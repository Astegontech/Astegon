...
export default function AdminLayout({
    ...
    return (
        <AdminAuth>
            <div className="min-h-screen bg-black text-white pt-16 selection:bg-white/20 flex">

                {/* Fixed Spacer for Main Content */}
                <div className="hidden md:block w-20 flex-shrink-0" />

                {/* Collapsible Sidebar (Absolute floating over main) */}
                <aside className="fixed left-0 top-16 bottom-0 w-full md:w-20 md:hover:w-64 transition-[width] duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] bg-[#0a0a0a] border-r border-white/10 z-50 overflow-hidden group shadow-2xl">
                    ...
                    <div className="w-full md:w-64 h-full flex flex-col">
                        ...
                        <nav className="space-y-2 px-4 mt-6 flex-1">
                ...
                {/* Main Content Area */}
                <main className="flex-1 w-full min-w-0 p-6 md:p-10 relative overflow-y-auto min-h-[calc(100vh-4rem)]">
