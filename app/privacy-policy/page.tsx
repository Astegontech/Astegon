        ...
        <main className={styles.main}>
            <div className={styles.container}>
                ...
                <div className={styles.contentWrapper}>
                    ...
                    <Reveal delay={0.2}>
                        <section>
                            <h2 className={styles.sectionTitle}>2. Implementation of Google Services</h2>
                    ...
                    <Reveal delay={0.3}>
                        <section>
                            <h2 className={styles.sectionTitle}>3. Data We Collect</h2>
                            <p className={styles.paragraph}>We may collect, use, store and transfer different kinds of personal data about you which we have grouped together follows:</p>
                    ...
                    <Reveal delay={0.4}>
                        <section>
                            ...
                            <p className={styles.paragraph}>We will only use your personal data when the law allows us to. Most commonly, we will use your personal data in the following circumstances:</p>
                            <ul className={styles.list}>
